...
public:
  ...
  void MoveBloons();
  // Name: CheckLead
  // Description: For each Lead bloon less than 11 health, delete and make black bloon
  // Preconditions: Lead bloon exists with less than 11 health 
  // Postconditions: No Lead bloon exists with less than 11 health 
  void CheckLead();
  // Name: CheckZebra
  // Description: For each Zebra bloon less than 13, delete and make black and whte bloon
  // Preconditions: Zebra bloon exists with less than 13 health 
  // Postconditions: No Zebra bloon exists with less than 13 health 
  void CheckZebra();
  // Name: CheckPath
